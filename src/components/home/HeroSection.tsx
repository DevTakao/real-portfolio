      ...
      <div className="hero-content absolute z-[1] top-0 left-0 w-full h-full flex flex-col items-center justify-center">
        <div className="hero-title inline-block relative">
          <h1
            ...
            className="font-title leading-none text-[18vw] text-white hover:[color:transparent] transition-colors duration-1000 bg-cover bg-center px-4 relative z-[1] cursor-pointer"
          >
            Takao
          </h1>
          ...
          <h2 className="text-[5vw] font-title [text-shadow:0px_-5px_10px_rgba(0,0,0,1)] px-4">
